...
def get_model_config(vocab_size=32128, d_model=512, d_kv=64, d_ff=2048, num_layers=6, num_heads=8, dropout_rate=0.1):
    """
    ...
    config = T5Config(
        ...
        pad_token_id=0,
        eos_token_id=1,
        decoder_start_token_id=0, # Typically pad or specifically start
    )
    return config

def get_model(config=None, vocab_size=32128):
    """
